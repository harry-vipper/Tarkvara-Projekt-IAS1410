function delay(timeoutTime, parameter) {
    return new Promise(function(resolve) { 
        setTimeout(resolve.bind(null, parameter), timeoutTime)
});
}
...
screen_splash={
    ...
    */
    ...
    let str=`
        ...
        delay(screenContent.movetime).then(()=>{
            ...
            delay(screenContent.movetime).then(()=>{
                delay(screenContent.staytime).then(()=>{
