var color=new function() {
    ...
    this.getTones=function(color) {
        return {
            dull: new this.Color(
                this.tones.constrain(color.H), 
                this.tones.constrain(color.S-100), 
                this.tones.constrain(color.L)
            ),
            darkest: new this.Color(
                this.tones.constrain(color.H), 
                this.tones.constrain(color.S), 
                this.tones.constrain(color.L-70)
            ),
            dark: new this.Color(
                this.tones.constrain(color.H), 
                this.tones.constrain(color.S), 
                this.tones.constrain(color.L-40)
            ),
            ...
            bright: new this.Color(
                this.tones.constrain(color.H), 
                this.tones.constrain(color.S*1.3), 
                this.tones.constrain(color.L+20)
            ),
            brightest: new this.Color(
                this.tones.constrain(color.H), 
                this.tones.constrain(color.S*1.6), 
                this.tones.constrain(color.L+100)
            ),
            bloom: new this.Color(
                this.tones.constrain(color.H), 
                this.tones.constrain(color.S*0.4-10),
                this.tones.constrain(color.L+100)
            )
        }
    };
